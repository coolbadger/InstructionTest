            ...
            {
                {
                    ...
                    this.panelCenter.add(this.scrollPane, BorderLayout.CENTER);
                    {
                        ...
                        //增加内容
                        List<CraneInfo> craneInfoList = ImportData.craneInfoList;
                        ...
                        for (CraneInfo craneInfo : craneInfoList) {
                            ...
                            rowData[15] = FileUtil.sdf.format(craneInfo.getWORKINGTIMERANGES().get(0).getWORKSTARTTIME())+"-"+FileUtil.sdf.format(craneInfo.getWORKINGTIMERANGES().get(0).getWORKENDTIME());
